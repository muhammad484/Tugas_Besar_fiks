...
<html lang="en">
  ...
  <body>
    ...
    <table class="table table-sm" style="margin-top: 5rem; padding-left: 40px;">
      <tr class="align-middle">
        <td>Nama </td>
        <td>
            <h6>: <?= $mhs["nama_mahasiswa"] ?></h6>
        </td>
        <td rowspan="8">
          <div class="card ms-auto" style="width: 18rem; margin-right: 40px;">
      ...
      <tr class="align-middle">
        <td>Asal Sekolah </td>
        <td>
          <h6>: <?= $mhs["asal_sekolah"] ?></h6>
        </td>
      </tr>
      <tr class="align-middle">
        <td>Tanggal Masuk </td>
        <td>
          <h6>: <?= $mhs["tanggal_masuk"] ?></h6>
        </td>
      </tr>
      <tr class="align-middle">
        <td>NIM </td>
